...
// side right
{
    ...
    var set = JSON.stringify(cv);
        localStorage.setItem("cv",set);

    var getCV = localStorage.getItem("cv");
    ...
    //competence
        ...
        document.getElementById("li1_logiciel").innerHTML = `${get[3].li1_logiciels}`;
        document.getElementById("li2_logiciel").innerHTML = `${get[3].li2_logiciels}`;
        document.getElementById("li3_logiciel").innerHTML = `${get[3].li3_logiciels}`;
        document.getElementById("li4_logiciel").innerHTML = `${get[3].li4_logiciels}`;
        document.getElementById("li5_logiciel").innerHTML = `${get[3].li5_logiciels}`;
        document.getElementById("li6_logiciel").innerHTML = `${get[3].li6_logiciels}`;
    //copyright
